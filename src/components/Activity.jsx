            ...
            <div className="rounded-lg activity">
                <div className="activityHead m-4 ml-2 mr-2 mt-12 rounded-lg">
                    ...
                    <div className="activityBody p-4 pt-2 rounded-lg">
                        ...
                        <div className="activityBottom flex justify-between p-3 flex-wrap">
                            <h2 className='text-white mt-6'>Today you make 12 activity</h2>
                            <button className='bg-red-500  pr-3 pl-3 text-white rounded mt-4' style={{padding:'2%'}}>See all activity</button>
                        </div>
                    </div>
                </div>
            </div>
